                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="repassword" id="inputName" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            if (isset($_POST['add_user'])) {
                                ...
                                if ($password == $repassword) {
                                    ...
                                    $data_insert = "INSERT INTO user(user_name,email,phone,password,user_address,user_role,user_status,profile,join_date) VALUES('$name','$email','$phone','$hash_password','$address','$role','$status','$final_img', now())";
